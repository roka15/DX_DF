...
namespace roka
{
	...
	public:
		...
		void Create(std::wstring npk_name,std::wstring pack_name,std::wstring set_name,int start_index,int end_index);
		...
		void PlayAnimation(const std::wstring& name, bool loop, float duration);
		void Binds();
